...
%utilizada uma placa de conexão interna de 90 graus, conforme \ref{fig:pconexao90p}Figura 3.3, que 
...
%O pórtico será feito com o perfil v\_slot de 20x20 mm em alumínio conforme apresenta a \ref{fig:p20x20p}
...
%entregar até 35 V por bobina. A \ref{fig:driverportas} mostra o driver com os respectivos componentes.
...
%para cada passo. A \ref{fig:didaticopasso} Figura 3.15 é um exemplo para melhor entendimento do conceito de passo.
...
%A \ref{fig:didaticopasso} mostra um motor de passo com cinquenta dentes de precisão, portanto combinando 
...
%As Tabelas \ref{tab:wavestephorario},\ref{tab:fullstepantihorario} e \ref{tab:halfstepantihorario} 
...
%A \ref{tab:pmotordepasso} Tabela 8 apresenta alguns parâmetros dos motores de passo.
...
%A \ref{tab:demandafonte} Tabela 9 apresenta a demanda de energia elétrica de cada dispositivo.
...
%A \ref{tab:demandafonte} Tabela 9 indica que a placa controladora Arduino opera no intervalo de tensão de 7 V a 12 V, 
...
%Outro parâmetro que a \ref{tab:demandafonte} Tabela 9 apresenta é a corrente elétrica mínima para a operação do circuito. 
...
%A \ref{fig:fluxoexecucao} Figura 3.20 apresenta um fluxograma simplificado da lógica de programação presente na placa controladora 
...
%desenvolvimento do código. Sendo assim a \ref{fig:diagramaclasses} Figura 3.21 apresentada abaixo é o resultado do que foi modelado.
...
%A \ref{tab:classesigmoidal} tabela 10 apresenta a declaração e funcionalidade dos atributos e métodos da classe “Sigmoidal”.
...
%A \ref{tab:classepino} tabela 11 apresenta a declaração e funcionalidade dos atributos e métodos da classe “Pino”.
...
%A \ref{tab:classedriver} tabela 12 apresenta a declaração e funcionalidade dos atributos e métodos da classe “Driver”
...
%A \ref{tab:classeeixo} tabela 13 apresenta a declaração e funcionalidade dos atributos e métodos da classe “Eixo”.
...
%A \ref{fig:orgsoftware} Figura 3.22 apresenta um diagrama geral da organização do software.
...
%A \ref{fig:integracao} Figura 3.23 é um fluxograma que descreve de maneira gráfica a integração dos sistemas.
