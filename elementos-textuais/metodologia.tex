...
%Será utilizado uma guia para o deslocamento horizontal, 
%para o deslocamento vertical será utilizado um fuso acoplado ao motor é uma guia no lado oposto, 
%apenas para dar suporte ao elemento que fixará o fuso horizontal.
