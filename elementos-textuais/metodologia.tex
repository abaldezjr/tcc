...
\begin{figure}[!htb]
\centering
\includegraphics[scale = 0.4]{figuras/p20x40p}
...
\begin{figure}[!htb]
\centering
\includegraphics[scale = 0.3]{figuras/estruturamesa}
...
\begin{figure}[!htb]
\centering
\includegraphics[scale = 0.5]{figuras/p20x20d}
...
\begin{figure}[!htb]
\centering
\includegraphics[scale = 0.40]{figuras/placatp}
...
\begin{figure}[!htb]
\centering
\includegraphics[scale = 0.4]{figuras/fluxogramaeletronico}
...
projeto contém 2 optoacopladores, 20mA são necessários. Decidiu-se acrescentar uma margem de 
