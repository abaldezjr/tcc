...
\begin{figure}[!htb]
\centering
\includegraphics[scale = 1]{figuras/3-4}
\caption{Dimensões da placa de conexão interna de 90º.}
\caption*{Fonte: www.forsetisolucoes.com.br}
\label{figpconexao90d}
\end{figure}
    
% Figura 3.5
% Estrutura da mesa cartesiana 
% (Fonte:Próprio autor)
\begin{figure}[!htb]
\centering
\includegraphics[scale = 1]{figuras/3-5}
\caption{Estrutura da mesa cartesiana.}
\caption*{Fonte: Próprio autor}
\label{figestruturamesa}
\end{figure}
...
\begin{figure}[!htb]
\centering
\includegraphics[scale = 1]{figuras/3-8}
...
\begin{figure}[!htb]
\centering
\includegraphics[scale = 1]{figuras/3-9}
...
% Figura 3.11
% Fluxograma do sistema eletrônico. 
% (Fonte: Próprio autor.) 
...
Em sua composição, a placa Arduino UNO contém um microcontrolador ATMEL ATMEGA328, que é um dispositivo de 8 bits da 
...
% Figura 3.12
% Descrição dos componentes da placa Arduino. 
% (Fonte: Próprio autor.)
...
% Figura 3.13
% Driver fabricado pela equipe do projeto 
% (Fonte: Próprio Autor)
...
% Figura 3.14
% Portas do driver fabricado pela equipe do projeto 
% (Fonte: Próprio Autor)
...
% Tabela 1
% Parâmetros do driver de potência.
% (Fonte: Próprio Autor)
...
% Figura 3.15
% Conceito didático do motor de passo 
% (Fonte: https://www.fernandok.com - 2021)
...
% Figura 3.16
% Esquema elétrico do motor de passo. 
% (Fonte: Próprio autor.)

As Tabelas 2, 3 e 4 mostram a sequência de polaridades aplicadas no motor no movimento de sentido horário.

% Tabela 2
% Sequência de passos com uma fase (wavestep) para movimentação no sentido horário.
% (Fonte: Próprio autor.)
...
% Tabela 3
% Sequência de passos com duas fases (fullstep) para movimentação no sentido horário.
% (Fonte: Próprio autor.)
...
% Tabela 4
% Sequência de passos com meio passo (halfstep) para movimentação no sentido horário.
% (Fonte: Próprio autor.)
...
% Tabela 5
% Sequência de passos com uma fase (wavestep) para movimentação no sentido anti-horário.
% (Fonte: Próprio autor.)
...
% Tabela 6
% Sequência de passos com duas fases (fullstep) para movimentação no sentido anti-horário.
% (Fonte: Próprio autor.)
...
% Tabela 7
% Sequência de passos com meio passo (halfstep) para movimentação no sentido anti-horário.
% (Fonte: Próprio autor.)
...
% Tabela 8
% Parâmetros dos motores de passo.
% (Fonte: Próprio autor.)
...
% Tabela 9
% Demanda de energia elétrica de cada componente do sistema.
% (Fonte: Próprio autor.)
...
% Figura 3.18
% Funcionamento do acoplador no sistema.
% (Fonte: Próprio autor)
...
% Figura 3.19
% Ambiente de desenvolvimento integrado Arduino.
% (Fonte: Próprio autor.)
...
% Figura 3.21
% Diagrama de classes do sistema de software presente no Arduino
% (Fonte: Próprio autor)
...
% Tabela 10
% Declaração e funcionalidade dos atributos e métodos da classe Sigmoidal
% (Fonte: Próprio autor.)
...
% Tabela 11
% Declaração e funcionalidade dos atributos e métodos da classe Pino
% (Fonte: Próprio autor.)
...
% Tabela 12
% Declaração e funcionalidade dos atributos e métodos da classe Driver.
% (Fonte: Próprio autor.)
...
A classe “Driver” possui os atributos privados: “pinoEnable”, que permite ligar ou desligar o driver, “pinoReset”, 
...
% Tabela 13
% Declaração e funcionalidade dos atributos e métodos da classe Eixo.
% (Fonte: Próprio autor.)
...
A classe “Eixo” possui os atributos privados: “driver”, que é responsável pelas configurações e operações do driver 
...
% Figura 3.22
% Diagrama da organização geral do software.
% (Fonte: Próprio autor.)
...
% Figura 3.23
% Fluxograma para apresentar a integração sistemas.
% (Fonte: Próprio autor.)
